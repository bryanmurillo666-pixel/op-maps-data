...
(function () {
  ...
  const DICT = {
    ...
    es: {
      ...
      'pve.isla.dmg':     'si pierde',
      'pve.isla.dmgNote': 'La vida que se deja cada uno sale de la guía v4.0, que es de cuando el PvE era una tirada: decía que al perder, los tres que desembarcaron pierden el 34 % de su vida máxima. Con el combate por duelos está por confirmar si ahora se aplican los números del PvP (34 % al que pierde el duelo y 8 % al que lo gana).',
      ...
      'pve.isla.guide50': 'La guía v4.0 dice que el PvE es un <b>50 % fijo</b> que no depende de nada. Eso es del sistema viejo: hoy es un 3 contra 3 de verdad, como confirma la v0.41.0 al decir que tu plan de ataque «es el grupo que desembarca cuando tu tripulación llega a una isla».',
      ...
      'pve.k.char':     'Vida de cada uno de los 3',
      'pve.k.goldLoss': 'Oro',
      'pve.k.stun':     'Aturdimiento',

      'pve.win.t': 'Si ganas',
      'pve.win.1': '<b>5000 de oro</b> y una victoria de combate más.',
      'pve.win.2': '<b>80 % de que aparezca una oferta</b> de tripulante. Se tira solo si has ganado, así que sobre el total de desembarcos sale un 40 %.',
      ...
      'pve.lose.2': 'Los <b>tres que desembarcaron</b> pierden cada uno el 34 % de su vida máxima, y pueden quedarse tumbados.',
      'pve.lose.3': 'Pierdes <b>500 de oro</b>, o todo lo que tengas si es menos.',
      'pve.lose.4': 'Te quedas <b>aturdido 90 minutos</b>.',
    ...
    en: {
      ...
      'pve.isla.dmg':     'if they lose',
      'pve.isla.dmgNote': 'The health each one leaves behind comes from guide v4.0, written when PvE was a dice roll: it said that on a loss the three who went ashore each lose 34 % of their max health. With duel-based combat it is still to be confirmed whether the PvP numbers now apply (34 % to the duel loser, 8 % to the winner).',
      ...
      'pve.isla.guide50': 'Guide v4.0 says PvE is a <b>flat 50 %</b> that depends on nothing. That is the old system: today it is a real 3v3, as v0.41.0 confirms when it says your attack plan "is the party that goes ashore when your crew reaches an island".',
      ...
      'pve.k.char':     'Health of each of the 3',
      'pve.k.goldLoss': 'Gold',
      'pve.k.stun':     'Stun',

      'pve.win.t': 'If you win',
      'pve.win.1': '<b>5000 gold</b> and one more battle victory.',
      'pve.win.2': 'An <b>80 % chance of a crew offer</b>. It is only rolled after a win, so across all landings it works out at 40 %.',
      ...
      'pve.lose.2': 'The <b>three who went ashore</b> each lose 34 % of their max health, and can be left down by it.',
      'pve.lose.3': 'You lose <b>500 gold</b>, or everything you have if it is less.',
      'pve.lose.4': 'You are <b>stunned for 90 minutes</b>.',
